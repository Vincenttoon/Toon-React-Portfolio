        ...
        <div className="bio-cont justify-center">
            ...
            <div className="vincent-info-container flex-column">
                ...
                <p className="info-text"> 
                    Graduate from Washington University's Full Stack Web Development Bootcamp.
                    As a developer, I have a passion for building applications from the ground up
                    and learning new technologies to both improve my knowledge of web development and 
                    boost the user's enjoyment of an application.
                </p>
                <br></br>
                ...
                <p className="info-text">
                    When I am not online I enjoy walking my dog, playing music, playing video games, catching up with friends and 
                    visiting breweries far and wide for great drinks and food.
                </p>
                <br></br>
